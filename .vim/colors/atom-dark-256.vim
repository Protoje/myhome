...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || (&term =~? "^konsole" && s:old_kde())
    CSAHi Normal term=NONE cterm=NONE ctermbg=NONE ctermfg=231 gui=NONE guibg=#1D1F21 guifg=#F8F8F2
    ...
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=NONE ctermfg=66 gui=NONE guibg=bg guifg=#465457
    CSAHi NonText term=bold cterm=bold ctermbg=NONE ctermfg=66 gui=bold guibg=bg guifg=#465457
    CSAHi Directory term=bold cterm=NONE ctermbg=NONE ctermfg=248 gui=NONE guibg=bg guifg=#AAAAAA
    ...
    CSAHi MoreMsg term=bold cterm=bold ctermbg=NONE ctermfg=156 gui=bold guibg=bg guifg=#A8FF60
    CSAHi ModeMsg term=bold cterm=bold ctermbg=NONE ctermfg=156 gui=bold guibg=bg guifg=#A8FF60
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=NONE ctermfg=189 gui=NONE guibg=bg guifg=#B6B7EB
    CSAHi NERDTreeLink term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi LightLineLeft_insert_0_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=NONE ctermfg=244 gui=NONE guibg=bg guifg=#7C7C7C
    CSAHi Constant term=underline cterm=NONE ctermbg=NONE ctermfg=151 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Special term=bold cterm=NONE ctermbg=234 ctermfg=117 gui=NONE guibg=NONE guifg=#66D9EF
    CSAHi vimSynRegion term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Statement term=bold cterm=NONE ctermbg=NONE ctermfg=153 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi PreProc term=underline cterm=NONE ctermbg=NONE ctermfg=187 gui=NONE guibg=bg guifg=#DAD085
    ...
    CSAHi Repeat term=NONE cterm=NONE ctermbg=NONE ctermfg=153 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi LightLineLeft_insert_raw_0 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiBang term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_insert_raw_1 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_0_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_raw_0 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_1_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_raw_1 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_2_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_raw_2 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_insert_tabsel_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi Ignore term=NONE cterm=NONE ctermbg=234 ctermfg=244 gui=NONE guibg=NONE guifg=#808080
    ...
    CSAHi Character term=NONE cterm=NONE ctermbg=NONE ctermfg=156 gui=NONE guibg=bg guifg=#A8FF60
    CSAHi Number term=NONE cterm=NONE ctermbg=NONE ctermfg=151 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Boolean term=NONE cterm=NONE ctermbg=NONE ctermfg=151 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Float term=NONE cterm=NONE ctermbg=NONE ctermfg=151 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Function term=NONE cterm=NONE ctermbg=NONE ctermfg=187 gui=NONE guibg=bg guifg=#DAD085
    ...
    CSAHi LightLineLeft_normal_0_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_normal_raw_0 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_insert_raw_tabsel term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_tabsel_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_raw_tabsel term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_insert_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_insert_raw_2 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_insert_2_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_raw_3 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_3_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_insert_raw_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiLink term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Conditional term=NONE cterm=NONE ctermbg=NONE ctermfg=153 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi vimHiKeyList term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Label term=NONE cterm=NONE ctermbg=NONE ctermfg=156 gui=NONE guibg=bg guifg=#A8FF60
    CSAHi Operator term=NONE cterm=NONE ctermbg=NONE ctermfg=153 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi Keyword term=NONE cterm=NONE ctermbg=NONE ctermfg=153 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi Exception term=NONE cterm=NONE ctermbg=NONE ctermfg=187 gui=NONE guibg=bg guifg=#DAD085
    CSAHi Define term=NONE cterm=NONE ctermbg=NONE ctermfg=117 gui=NONE guibg=bg guifg=#66D9EF
    CSAHi Macro term=NONE cterm=NONE ctermbg=NONE ctermfg=187 gui=NONE guibg=bg guifg=#C4BE89
    CSAHi PreCondit term=NONE cterm=NONE ctermbg=NONE ctermfg=187 gui=NONE guibg=bg guifg=#DAD085
    ...
    CSAHi LightLineLeft_normal_1_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_normal_raw_1 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_normal_0_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=59 ctermfg=fg gui=NONE guibg=#293739 guifg=fg
    CSAHi LightLineRight_insert_raw_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi Tag term=NONE cterm=NONE ctermbg=NONE ctermfg=153 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi SpecialChar term=NONE cterm=NONE ctermbg=NONE ctermfg=153 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=NONE ctermfg=245 gui=NONE guibg=bg guifg=#8F8F8F
    CSAHi SpecialComment term=NONE cterm=NONE ctermbg=NONE ctermfg=244 gui=NONE guibg=bg guifg=#7C7C7C
    CSAHi Debug term=NONE cterm=NONE ctermbg=NONE ctermfg=181 gui=NONE guibg=bg guifg=#BCA3A3
    ...
    CSAHi LightLineRight_normal_raw_0 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_normal_1_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_normal_raw_1 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_insert_1_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi LightLineRight_command_1_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi LightLineRight_normal_2_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_normal_raw_2 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi Todo term=NONE cterm=NONE ctermbg=234 ctermfg=231 gui=NONE guibg=NONE guifg=#FFFFFF
    ...
    CSAHi LightLineLeft_command_0_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_command_raw_0 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimCollClass term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_normal_tabsel_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_normal_raw_tabsel term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_command_1_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_command_raw_1 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_command_0_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_command_raw_0 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi pythonSpaceError term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_command_raw_1 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_command_2_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_command_raw_2 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_command_tabsel_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_command_raw_tabsel term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi pythonSync term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_normal_tabsel_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi LightLineRight_normal_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimMapRhs term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_normal_raw_2 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimMapRhsExtend term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_normal_raw_tabsel term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi StorageClass term=NONE cterm=NONE ctermbg=NONE ctermfg=189 gui=NONE guibg=bg guifg=#B6B7EB
    CSAHi LightLineLeft_normal_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi LightLineRight_command_tabsel_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_command_raw_tabsel term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_command_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_command_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_command_raw_2 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_command_2_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_command_raw_3 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_command_3_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_command_raw_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_command_raw_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi CursorLineNr term=bold cterm=NONE ctermbg=NONE ctermfg=189 gui=NONE guibg=bg guifg=#B6B7EB
    ...
    CSAHi Title term=bold cterm=NONE ctermbg=NONE ctermfg=189 gui=NONE guibg=bg guifg=#B6B7EB
    ...
    CSAHi LightLineLeft_normal_2_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_normal_raw_3 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_normal_3_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_normal_raw_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimAuSyntax term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_normal_raw_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    CSAHi Normal term=NONE cterm=NONE ctermbg=NONE ctermfg=255 gui=NONE guibg=#1D1F21 guifg=#F8F8F2
    CSAHi vimFiletype term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimExecute term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimFunction term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi LightLineRight_normal_0 term=NONE cterm=NONE ctermbg=252 ctermfg=241 gui=NONE guibg=#d0d0d0 guifg=#606060
    CSAHi LightLineRight_normal_0_tabsel term=NONE cterm=NONE ctermbg=235 ctermfg=252 gui=NONE guibg=#262626 guifg=#d0d0d0
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=NONE ctermfg=102 gui=NONE guibg=bg guifg=#465457
    CSAHi NonText term=bold cterm=bold ctermbg=NONE ctermfg=102 gui=bold guibg=bg guifg=#465457
    CSAHi Directory term=bold cterm=NONE ctermbg=NONE ctermfg=188 gui=NONE guibg=bg guifg=#AAAAAA
    ...
    CSAHi Search term=reverse cterm=NONE ctermbg=193 ctermfg=16 gui=NONE guibg=#B4EC85 guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=NONE ctermfg=192 gui=bold guibg=bg guifg=#A8FF60
    CSAHi ModeMsg term=bold cterm=bold ctermbg=NONE ctermfg=192 gui=bold guibg=bg guifg=#A8FF60
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=238 ctermfg=188 gui=NONE guibg=#444444 guifg=#B7B9B8
    CSAHi Comment term=bold cterm=NONE ctermbg=NONE ctermfg=145 gui=NONE guibg=bg guifg=#7C7C7C
    CSAHi Constant term=underline cterm=NONE ctermbg=NONE ctermfg=194 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Special term=bold cterm=NONE ctermbg=234 ctermfg=123 gui=NONE guibg=NONE guifg=#66D9EF
    CSAHi vimSynRegion term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Statement term=bold cterm=NONE ctermbg=NONE ctermfg=159 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi PreProc term=underline cterm=NONE ctermbg=NONE ctermfg=229 gui=NONE guibg=bg guifg=#DAD085
    ...
    CSAHi LightLineLeft_normal_tabsel_tabsel term=NONE cterm=NONE ctermbg=235 ctermfg=235 gui=NONE guibg=#262626 guifg=#262626
    CSAHi LightLineRight_normal_tabsel_tabsel term=NONE cterm=NONE ctermbg=235 ctermfg=235 gui=NONE guibg=#262626 guifg=#262626
    CSAHi Repeat term=NONE cterm=NONE ctermbg=NONE ctermfg=159 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi LightLineLeft_insert_raw_0 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiBang term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_insert_raw_1 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_0_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi Character term=NONE cterm=NONE ctermbg=NONE ctermfg=192 gui=NONE guibg=bg guifg=#A8FF60
    CSAHi Number term=NONE cterm=NONE ctermbg=NONE ctermfg=194 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Boolean term=NONE cterm=NONE ctermbg=NONE ctermfg=194 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Float term=NONE cterm=NONE ctermbg=NONE ctermfg=194 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Function term=NONE cterm=NONE ctermbg=NONE ctermfg=229 gui=NONE guibg=bg guifg=#DAD085
    CSAHi vimMenuMap term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_inactive_0_tabsel term=NONE cterm=NONE ctermbg=235 ctermfg=235 gui=NONE guibg=#262626 guifg=#262626
    CSAHi LightLineLeft_inactive_tabsel_0 term=NONE cterm=NONE ctermbg=235 ctermfg=235 gui=NONE guibg=#262626 guifg=#262626
    CSAHi LightLineMiddle_inactive term=NONE cterm=NONE ctermbg=236 ctermfg=245 gui=NONE guibg=#303030 guifg=#8a8a8a
    ...
    CSAHi LightLineLeft_insert_raw_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiLink term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Conditional term=NONE cterm=NONE ctermbg=NONE ctermfg=159 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi vimHiKeyList term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Label term=NONE cterm=NONE ctermbg=NONE ctermfg=192 gui=NONE guibg=bg guifg=#A8FF60
    CSAHi Operator term=NONE cterm=NONE ctermbg=NONE ctermfg=159 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi Keyword term=NONE cterm=NONE ctermbg=NONE ctermfg=159 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi Exception term=NONE cterm=NONE ctermbg=NONE ctermfg=229 gui=NONE guibg=bg guifg=#DAD085
    CSAHi Define term=NONE cterm=NONE ctermbg=NONE ctermfg=123 gui=NONE guibg=bg guifg=#66D9EF
    CSAHi Macro term=NONE cterm=NONE ctermbg=NONE ctermfg=223 gui=NONE guibg=bg guifg=#C4BE89
    CSAHi PreCondit term=NONE cterm=NONE ctermbg=NONE ctermfg=229 gui=NONE guibg=bg guifg=#DAD085
    CSAHi LightLineRight_inactive_tabsel_1 term=NONE cterm=NONE ctermbg=235 ctermfg=235 gui=NONE guibg=#262626 guifg=#262626
    CSAHi LightLineLeft_inactive_tabsel term=NONE cterm=NONE ctermbg=235 ctermfg=250 gui=NONE guibg=#262626 guifg=#bcbcbc
    CSAHi LightLineRight_inactive_tabsel term=NONE cterm=NONE ctermbg=235 ctermfg=250 gui=NONE guibg=#262626 guifg=#bcbcbc
    CSAHi LightLineLeft_inactive_tabsel_1 term=NONE cterm=NONE ctermbg=236 ctermfg=235 gui=NONE guibg=#303030 guifg=#262626
    ...
    CSAHi Tag term=NONE cterm=NONE ctermbg=NONE ctermfg=159 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi SpecialChar term=NONE cterm=NONE ctermbg=NONE ctermfg=159 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=NONE ctermfg=245 gui=NONE guibg=bg guifg=#8F8F8F
    CSAHi SpecialComment term=NONE cterm=NONE ctermbg=NONE ctermfg=145 gui=NONE guibg=bg guifg=#7C7C7C
    CSAHi Debug term=NONE cterm=NONE ctermbg=NONE ctermfg=188 gui=NONE guibg=bg guifg=#BCA3A3
    CSAHi Cursor term=NONE cterm=NONE ctermbg=243 ctermfg=255 gui=NONE guibg=#777777 guifg=#F1F1F1
    CSAHi iCursor term=NONE cterm=NONE ctermbg=243 ctermfg=255 gui=NONE guibg=#777777 guifg=#F1F1F1
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=232 ctermfg=fg gui=NONE guibg=#080808 guifg=fg
    ...
    CSAHi vimSyncMatch term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSyncLinebreak term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Todo term=NONE cterm=NONE ctermbg=234 ctermfg=255 gui=NONE guibg=NONE guifg=#FFFFFF
    CSAHi vimSyncRegion term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimExtCmd term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimFilter term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSet term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi LightLineRight_normal_0_tabsel term=NONE cterm=NONE ctermbg=235 ctermfg=252 gui=NONE guibg=#262626 guifg=#d0d0d0
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=NONE ctermfg=59 gui=NONE guibg=bg guifg=#465457
    ...
    CSAHi MoreMsg term=bold cterm=bold ctermbg=NONE ctermfg=155 gui=bold guibg=bg guifg=#A8FF60
    CSAHi ModeMsg term=bold cterm=bold ctermbg=NONE ctermfg=155 gui=bold guibg=bg guifg=#A8FF60
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=NONE ctermfg=146 gui=NONE guibg=bg guifg=#B6B7EB
    CSAHi NERDTreeLink term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimOperParen term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimRegion term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSynLine term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi Special term=bold cterm=NONE ctermbg=234 ctermfg=81 gui=NONE guibg=NONE guifg=#66D9EF
    CSAHi vimSynRegion term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Statement term=bold cterm=NONE ctermbg=NONE ctermfg=117 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi PreProc term=underline cterm=NONE ctermbg=NONE ctermfg=186 gui=NONE guibg=bg guifg=#DAD085
    ...
    CSAHi LightLineLeft_normal_tabsel_tabsel term=NONE cterm=NONE ctermbg=235 ctermfg=235 gui=NONE guibg=#262626 guifg=#262626
    CSAHi LightLineRight_normal_tabsel_tabsel term=NONE cterm=NONE ctermbg=235 ctermfg=235 gui=NONE guibg=#262626 guifg=#262626
    CSAHi Repeat term=NONE cterm=NONE ctermbg=NONE ctermfg=117 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi LightLineLeft_insert_raw_0 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiBang term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_insert_raw_1 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_0_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi Character term=NONE cterm=NONE ctermbg=NONE ctermfg=155 gui=NONE guibg=bg guifg=#A8FF60
    CSAHi Number term=NONE cterm=NONE ctermbg=NONE ctermfg=114 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Boolean term=NONE cterm=NONE ctermbg=NONE ctermfg=114 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Float term=NONE cterm=NONE ctermbg=NONE ctermfg=114 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Function term=NONE cterm=NONE ctermbg=NONE ctermfg=186 gui=NONE guibg=bg guifg=#DAD085
    CSAHi vimMenuMap term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_inactive_0_tabsel term=NONE cterm=NONE ctermbg=235 ctermfg=235 gui=NONE guibg=#262626 guifg=#262626
    CSAHi LightLineLeft_inactive_tabsel_0 term=NONE cterm=NONE ctermbg=235 ctermfg=235 gui=NONE guibg=#262626 guifg=#262626
    CSAHi LightLineMiddle_inactive term=NONE cterm=NONE ctermbg=236 ctermfg=245 gui=NONE guibg=#303030 guifg=#8a8a8a
    ...
    CSAHi LightLineLeft_insert_raw_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiLink term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Conditional term=NONE cterm=NONE ctermbg=NONE ctermfg=117 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi vimHiKeyList term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Label term=NONE cterm=NONE ctermbg=NONE ctermfg=155 gui=NONE guibg=bg guifg=#A8FF60
    CSAHi Operator term=NONE cterm=NONE ctermbg=NONE ctermfg=117 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi Keyword term=NONE cterm=NONE ctermbg=NONE ctermfg=117 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi Exception term=NONE cterm=NONE ctermbg=NONE ctermfg=186 gui=NONE guibg=bg guifg=#DAD085
    CSAHi Define term=NONE cterm=NONE ctermbg=NONE ctermfg=81 gui=NONE guibg=bg guifg=#66D9EF
    CSAHi Macro term=NONE cterm=NONE ctermbg=NONE ctermfg=180 gui=NONE guibg=bg guifg=#C4BE89
    CSAHi PreCondit term=NONE cterm=NONE ctermbg=NONE ctermfg=186 gui=NONE guibg=bg guifg=#DAD085
    CSAHi LightLineRight_inactive_tabsel_1 term=NONE cterm=NONE ctermbg=235 ctermfg=235 gui=NONE guibg=#262626 guifg=#262626
    CSAHi LightLineLeft_inactive_tabsel term=NONE cterm=NONE ctermbg=235 ctermfg=250 gui=NONE guibg=#262626 guifg=#bcbcbc
    CSAHi LightLineRight_inactive_tabsel term=NONE cterm=NONE ctermbg=235 ctermfg=250 gui=NONE guibg=#262626 guifg=#bcbcbc
    CSAHi LightLineLeft_inactive_tabsel_1 term=NONE cterm=NONE ctermbg=236 ctermfg=235 gui=NONE guibg=#303030 guifg=#262626
    ...
    CSAHi Tag term=NONE cterm=NONE ctermbg=NONE ctermfg=117 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi SpecialChar term=NONE cterm=NONE ctermbg=NONE ctermfg=117 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=NONE ctermfg=245 gui=NONE guibg=bg guifg=#8F8F8F
    CSAHi SpecialComment term=NONE cterm=NONE ctermbg=NONE ctermfg=244 gui=NONE guibg=bg guifg=#7C7C7C
    CSAHi Debug term=NONE cterm=NONE ctermbg=NONE ctermfg=145 gui=NONE guibg=bg guifg=#BCA3A3
    CSAHi Cursor term=NONE cterm=NONE ctermbg=243 ctermfg=255 gui=NONE guibg=#777777 guifg=#F1F1F1
    CSAHi iCursor term=NONE cterm=NONE ctermbg=243 ctermfg=255 gui=NONE guibg=#777777 guifg=#F1F1F1
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=232 ctermfg=fg gui=NONE guibg=#080808 guifg=fg
    CSAHi LightLineLeft_command_0_1 term=NONE cterm=NONE ctermbg=240 ctermfg=148 gui=NONE guibg=#585858 guifg=#afdf00
    ...
    CSAHi vimMapRhsExtend term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_normal_raw_tabsel term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi StorageClass term=NONE cterm=NONE ctermbg=NONE ctermfg=146 gui=NONE guibg=bg guifg=#B6B7EB
    CSAHi LightLineLeft_normal_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimPythonRegion term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimAugroupSyncA term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_command_tabsel_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimMenuBang term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimMenuPriority term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi CursorLineNr term=bold cterm=NONE ctermbg=NONE ctermfg=146 gui=NONE guibg=bg guifg=#B6B7EB
    ...
    CSAHi StatusLineNC term=reverse cterm=reverse ctermbg=244 ctermfg=232 gui=reverse guibg=#080808 guifg=#808080
    CSAHi VertSplit term=reverse cterm=reverse ctermbg=244 ctermfg=232 gui=reverse guibg=#080808 guifg=#808080
    CSAHi Title term=bold cterm=NONE ctermbg=NONE ctermfg=146 gui=NONE guibg=bg guifg=#B6B7EB
    CSAHi Visual term=reverse cterm=NONE ctermbg=59 ctermfg=fg gui=NONE guibg=#403D3D guifg=fg
    CSAHi VisualNOS term=NONE cterm=NONE ctermbg=59 ctermfg=fg gui=NONE guibg=#403D3D guifg=fg
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=NONE ctermfg=81 gui=NONE guibg=bg guifg=#465457
    CSAHi NonText term=bold cterm=bold ctermbg=NONE ctermfg=81 gui=bold guibg=bg guifg=#465457
    CSAHi Directory term=bold cterm=NONE ctermbg=NONE ctermfg=84 gui=NONE guibg=bg guifg=#AAAAAA
    ...
    CSAHi MoreMsg term=bold cterm=bold ctermbg=NONE ctermfg=45 gui=bold guibg=bg guifg=#A8FF60
    CSAHi ModeMsg term=bold cterm=bold ctermbg=NONE ctermfg=45 gui=bold guibg=bg guifg=#A8FF60
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=NONE ctermfg=59 gui=NONE guibg=bg guifg=#B6B7EB
    CSAHi NERDTreeLink term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimOperParen term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimRegion term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSynLine term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=NONE ctermfg=82 gui=NONE guibg=bg guifg=#7C7C7C
    CSAHi Constant term=underline cterm=NONE ctermbg=NONE ctermfg=41 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Special term=bold cterm=NONE ctermbg=80 ctermfg=43 gui=NONE guibg=NONE guifg=#66D9EF
    CSAHi vimSynRegion term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Statement term=bold cterm=NONE ctermbg=NONE ctermfg=43 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi PreProc term=underline cterm=NONE ctermbg=NONE ctermfg=57 gui=NONE guibg=bg guifg=#DAD085
    ...
    CSAHi Repeat term=NONE cterm=NONE ctermbg=NONE ctermfg=43 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi LightLineLeft_insert_raw_0 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiBang term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineLeft_insert_raw_1 term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_insert_0_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi Ignore term=NONE cterm=NONE ctermbg=80 ctermfg=83 gui=NONE guibg=NONE guifg=#808080
    ...
    CSAHi Character term=NONE cterm=NONE ctermbg=NONE ctermfg=45 gui=NONE guibg=bg guifg=#A8FF60
    CSAHi Number term=NONE cterm=NONE ctermbg=NONE ctermfg=41 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Boolean term=NONE cterm=NONE ctermbg=NONE ctermfg=41 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Float term=NONE cterm=NONE ctermbg=NONE ctermfg=41 gui=NONE guibg=bg guifg=#99CC99
    CSAHi Function term=NONE cterm=NONE ctermbg=NONE ctermfg=57 gui=NONE guibg=bg guifg=#DAD085
    CSAHi vimMenuMap term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi LightLineLeft_insert_raw_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiLink term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Conditional term=NONE cterm=NONE ctermbg=NONE ctermfg=43 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi vimHiKeyList term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Label term=NONE cterm=NONE ctermbg=NONE ctermfg=45 gui=NONE guibg=bg guifg=#A8FF60
    CSAHi Operator term=NONE cterm=NONE ctermbg=NONE ctermfg=43 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi Keyword term=NONE cterm=NONE ctermbg=NONE ctermfg=43 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi Exception term=NONE cterm=NONE ctermbg=NONE ctermfg=57 gui=NONE guibg=bg guifg=#DAD085
    CSAHi Define term=NONE cterm=NONE ctermbg=NONE ctermfg=43 gui=NONE guibg=bg guifg=#66D9EF
    CSAHi Macro term=NONE cterm=NONE ctermbg=NONE ctermfg=57 gui=NONE guibg=bg guifg=#C4BE89
    CSAHi PreCondit term=NONE cterm=NONE ctermbg=NONE ctermfg=57 gui=NONE guibg=bg guifg=#DAD085
    ...
    CSAHi Tag term=NONE cterm=NONE ctermbg=NONE ctermfg=43 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi SpecialChar term=NONE cterm=NONE ctermbg=NONE ctermfg=43 gui=NONE guibg=bg guifg=#92C5F7
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=NONE ctermfg=83 gui=NONE guibg=bg guifg=#8F8F8F
    CSAHi SpecialComment term=NONE cterm=NONE ctermbg=NONE ctermfg=82 gui=NONE guibg=bg guifg=#7C7C7C
    CSAHi Debug term=NONE cterm=NONE ctermbg=NONE ctermfg=53 gui=NONE guibg=bg guifg=#BCA3A3
    ...
    CSAHi vimSyncMatch term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSyncLinebreak term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Todo term=NONE cterm=NONE ctermbg=80 ctermfg=79 gui=NONE guibg=NONE guifg=#FFFFFF
    CSAHi vimSyncRegion term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimExtCmd term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimFilter term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSet term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimMapRhsExtend term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_normal_raw_tabsel term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi StorageClass term=NONE cterm=NONE ctermbg=NONE ctermfg=59 gui=NONE guibg=bg guifg=#B6B7EB
    CSAHi LightLineLeft_normal_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimPythonRegion term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimAugroupSyncA term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi LightLineRight_command_tabsel_raw term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimMenuBang term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimMenuPriority term=NONE cterm=NONE ctermbg=NONE ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi CursorLineNr term=bold cterm=NONE ctermbg=NONE ctermfg=59 gui=NONE guibg=bg guifg=#B6B7EB
    ...
    CSAHi Title term=bold cterm=NONE ctermbg=NONE ctermfg=59 gui=NONE guibg=bg guifg=#B6B7EB
